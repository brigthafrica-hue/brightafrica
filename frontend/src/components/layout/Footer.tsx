...
function SocialIcon({ name }: { name: string }) {
  const icons: Record<string, React.ReactNode> = {
    ...
    tiktok: (
      <svg className="w-4 h-4 pointer-events-none" fill="currentColor" viewBox="0 0 24 24">
        <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64c.298-.002.595.042.88.13V9.4a6.33 6.33 0 00-1-.08A6.34 6.34 0 003 15.66a6.34 6.34 0 0010.82 4.47v-7.14a8.16 8.16 0 004.87 1.6v-3.59a4.87 4.87 0 01-.9-.11z"/>
      </svg>
    ),
    linkedin: (
      <svg className="w-4 h-4 pointer-events-none" fill="currentColor" viewBox="0 0 24 24">
