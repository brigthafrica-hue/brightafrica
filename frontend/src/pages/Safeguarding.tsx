              ...
              {reportSuccess && (
                <div className="p-8 mb-8 bg-emerald-50 dark:bg-emerald-950/40 border-2 border-emerald-500 rounded-2xl space-y-4">
                  ...
                  <p className="text-sm text-emerald-800 dark:text-emerald-200">
                    Votre signalement a été chiffré et envoyé au Référent Protection de l'ONG Bright Africa. Votre démarche contribue directement à la sécurité et à la protection des enfants.
                  </p>
