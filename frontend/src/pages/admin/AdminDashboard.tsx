...
export default function AdminDashboard() {
  const { data, isAuthenticated, logout, currentUser, isSyncing, syncError, isCloudLoaded } = useAdminData();
        ...
        <header className="admin-topbar">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            {isSyncing ? (
              ...
              <div title={syncError} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', padding: '0.3rem 0.75rem', borderRadius: '9999px', background: 'rgba(239,68,68,0.15)', color: '#F87171', fontSize: '0.75rem', fontWeight: 600 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', padding: '0.3rem 0.75rem', borderRadius: '9999px', background: 'rgba(34,197,94,0.15)', color: '#4ADE80', fontSize: '0.75rem', fontWeight: 600 }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5}>
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" d="m9 12.75 2.25 2.25 3-4.5" />
                </svg>
                Cloud connecté
              </div>
            ) : null}
