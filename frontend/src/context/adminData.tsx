...
const DEFAULT_DATA: AdminData = {
  ...
  news: [
    ...
    },
    {
      ...
      excerpt: 'L\'ONG Bright Africa a distribué des fournitures scolaires complètes à 200 enfants vulnérables pour la rentrée.',
      excerpt_en: 'Bright Africa distributed complete school supplies to 200 vulnerable children for the back-to-school season.',
      date: '02 Juin 2026',
      category: 'Protection',
